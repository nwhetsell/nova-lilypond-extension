...
with open('LilyPond.novaextension/Queries/lilypond-built-in-highlights.scm', 'w') as file:
    backslash_prefix = r'^\\\\'
...
with open('LilyPond.novaextension/Queries/scheme-lilypond-built-in-highlights.scm', 'w') as file:
...
with open('LilyPond.novaextension/Queries/scheme-built-in-highlights.scm', 'w') as file:
